...
| **M-02** | A-05 (données clients) | STRIDE-S | **Usurpation des comptes clients par credential stuffing (F1).** ⚠️ *Deux mécanismes distincts, souvent confondus* : **(M-02a) credential stuffing** — réutilisation d'une liste d'identifiants volés ailleurs (sans rapport avec le hachage) ; **(M-02b) cassage hors ligne** des hash **SHA-1** (algorithme obsolète, attaquable, tables arc-en-ciel) une fois la base exfiltrée via M-04/M-08. Les deux convergent vers les mêmes contre-mesures (bcrypt/argon2 + 2FA) mais M-02a relève de l'authentification (5.15/8.5) et M-02b de la cryptographie (8.24). | — | STRIDE-S ; etude-de-cas.md § 4, § 9 |
...
| **M-12** | A-05 (données clients) | LINDDUN-Disclosure | **Divulgation des données personnelles clients (risque de *conséquence*, non cumulé avec M-04/M-08/M-10).** Il ne se réalise pas seul : *si* M-04, M-08 ou M-10 se réalise, le fichier clients (nom, e-mail, adresse, tél., historique, hash SHA-1) est exposé en masse pour des citoyens européens. M-12 exprime l'impact **réglementaire et préjudiciable spécifique** de ces compromissions (notification 72 h art. 33 **non préparée**, sanction, préjudice aux personnes) — pas un risque d'occurrence indépendant. | — | LINDDUN-Disclosure ; etude-de-cas.md § 4, § 7 |
| **M-13** | A-11, A-05 (consentement newsletter, données clients) | LINDDUN-NC | **Non-conformité RGPD des traitements.** Registre des traitements **absent**, pas de DPO, mentions légales **incomplètes**, droit à l'oubli **non automatisé**, consentement newsletter « cases décochées mal enregistrées » (A-11). Le traitement est en non-conformité récurrente (art. 5, 6, 17, 30, 37 RGPD) : plainte ou contrôle CNIL → mise en demeure puis amende administrative **jusqu'à 4 % du CA mondial ou 20 M€** pour les manquements aux art. 5/6/17 (art. 83(5) RGPD ; palier inférieur de 2 % pour les seuls art. 30/37, art. 83(4)), sans compter le risque réputation. | — | LINDDUN-NC ; etude-de-cas.md § 7 ; 01-actifs.md A-11 |
...
| `LINDDUN-L`, `LINDDUN-I`, `LINDDUN-Disclosure`, `LINDDUN-NC` | Vie privée sur A-05, A-06, A-11 (KU Leuven ; RGPD UE 2016/679) |
